...
class StackWalkerLocationResolverTest {
    ...
    @Test
    void testResolve() {
        StackWalkerLocationResolver resolver = new StackWalkerLocationResolver("com.dua3.sawmill.lumberjack.support.StackWalkerLocationResolverTest$Infra");
    ...
    void testResolveWithMultipleInfraPackages() {
        StackWalkerLocationResolver resolver = new StackWalkerLocationResolver(
                "com.dua3.sawmill.lumberjack.support.StackWalkerLocationResolverTest$Infra",
                "com.dua3.sawmill.lumberjack.support.StackWalkerLocationResolverTest$OtherInfra"
        );
